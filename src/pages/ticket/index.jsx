            ...
            <form onSubmit={formik.handleSubmit} class="ml-5 mr-5 needs-validation" noValidate>
                ...
                <div id="channelGroup" className="form-group  d-flex flex-column">
                    <div class="ml-3 pl-1">
                        ...
                        <div class="invalid-feedback ml-mn-20">
                ...
                <div id="alert" class="alert alert-success alert-dismissible collapse" role="alert">
                ...
                <div class="d-flex flex-row justify-content-center  mt-5 mb-4">
                    ...
                    <div class="p-2 "> <button className="btn btn-primary supremo-btn justify-content-center mb-5" type="submit">Submit</button></div>
